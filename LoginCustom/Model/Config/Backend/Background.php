...
class Background extends BackendImage
{   

    const BACKGROUND_UPLOAD_DIR = 'logincustom/background';
    ...
    {
        return $this->_mediaDirectory->getAbsolutePath($this->_appendScopeInfo(self::BACKGROUND_UPLOAD_DIR));
    }
    ...
    public function beforeSave()
    {
        ...
        if ($deleteFlag || $this->getTmpFileName()) {
            $oldImagePath = $this->_mediaDirectory->getAbsolutePath(self::BACKGROUND_UPLOAD_DIR . '/' . $this->getOldValue());
